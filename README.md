# Cascaron · real-miramar-board

Este repo **no tiene codigo**. Es una direccion vieja que sigue viva.

El tablero real vive en `yodesarrollomx/real-miramar-board` y se sirve en:
...
`https://alexpueblag.github.io/real-miramar-board/` daria 404 para siempre.
